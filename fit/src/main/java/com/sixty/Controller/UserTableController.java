        ...
        for(Schedule schedule: schedules){
            ...
            for(int i=0; i<7; i++){
                if(dateSchedule.equals(dates[i])){
                    String text = TrainerInfoMapper.findTrainerIntroByName(schedule.getTrainerName()).getRealName()+"\n"+schedule.getType();
                    ...
                    label.setOnMouseClicked(new EventHandler<MouseEvent>() {
                        ...
                        public void handle(MouseEvent mouseEvent) {
                            mySession.setTrainer(UserMapper.findTrainerByName(schedule.getTrainerName()));
                            mySession.setTrainerInfo(TrainerInfoMapper.findTrainerIntroByName(schedule.getTrainerName()));
